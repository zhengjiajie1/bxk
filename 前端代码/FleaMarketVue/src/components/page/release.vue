                ...
                <div class="release-idle-container-form">
                    ...
                    <div class="price-stock-container">
                        <div class="form-item">
                            ...
                            <div class="input-tip">设置合理的价格更容易售出</div>
                        </div>
                        
                        <div class="form-item">
                            <div class="input-label">商品库存</div>
                            <el-input-number 
                                v-model="idleItemInfo.idleStock" 
                                :min="1" 
                                :step="1"
                                placeholder="请输入库存数量">
                            </el-input-number>
                            <div class="input-tip">设置商品的可售数量</div>
                        </div>
                    </div>
                ...
                if(this.idleItemInfo.idleName&&
                    ...
                    this.$api.addIdleItem(this.idleItemInfo).then(res=>{
                        if (res.status_code === 1) {
                            this.$message({
                                message: '商品发布成功！请耐心等待管理员审核，审核通过后商品将自动上架。',
                                type: 'success',
                                duration: 5000
                            });
...
<style scoped>
    ...
    .price-stock-container .form-item {
        width: 45%;
    }
