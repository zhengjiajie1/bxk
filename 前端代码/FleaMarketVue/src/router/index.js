...
export default new Router({
    routes: [
        ...
        {
            path: '/wallet',
            component: () => import('../components/page/wallet.vue'),
            meta: { title: '我的钱包 | 二手物品交易平台' }
        },
        {
            path: '/release',
        ...
        {
            path: '/store/:userId?',
            component: () => import('../components/page/store-front.vue'),
            meta: { title: '商品橱窗 | 二手物品交易平台' }
        },
        {
            path: '/order',
        ...
        {
            path: '/review',
            component: () => import('../components/page/review.vue'),
            meta: { title: '商品评价 | 二手物品交易平台' }
        },
        {
            path: '/login',
